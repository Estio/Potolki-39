...
Muse.Utils.allStyleSheetRulesFromOneSheet = function (a, b) {
    ...
    for (var f = [], j = $(window), h = function (a) {
        if (4 != a.type || 1 != a.media.length)return !1;
        var b = j.data("muse-mq");
        if (!b)return !1;
        if (a.media[0] == b)return !0;
        if (a.media.mediaText && 0 <= a.media.mediaText.indexOf(b.replace(/\s/g, "")))return !0;
        ...
        var k = d[i];
        if (h(k)) {
            if (k = Muse.Utils.allStyleSheetRulesFromOneSheet(k, b), null != k)for (var l = 0; l < k.length; l++)f.push(k[l])
        } else if (Muse.Utils.isDefined(k.selectorText))if (c)b(k.selectorText) && f.push(k); else for (var l = k.selectorText.split(/\s*,\s*/), m = 0; m < l.length; m++)b(l[m]) && f.push(k)
    }
    return f.length ?
        f : null
};
...
Muse.Utils.enableAnchorLinksActiveState = function () {
    var a = !1, b = [], c = $(window), d = Muse.Utils.getPageStyleSheets(), g = function (a) {
        ...
        a:{
            var o = 0;
            d = b.length;
            for (var m; o < d; o++)if (m = b[o], m.from <= c && c <= m.to) {
                d = o;
                break a
            }
            d = -1
        ...
        for (d = Math.min(d + 2, b.length); o < d; o++)if (q = b[o], m = q.$elem.offset().left + (i && !i.isStandard() ? i.scrollLeft() : 0), y = q.$elem.offset().top + (i && !i.isStandard() ? i.scrollTop() : 0), q.from != (a ? m :
                y)) {
            j(l);
            break
        }
        ...
        for (d = b.length; o < d; o++) {
            ...
            q = q.hyperLinks;
            y = void 0;
            for (var C = 0; C < q.length; C++)y = g(q[C]), m && !q[C].hasClass(y) ? q[C].addClass(y) : !m && q[C].hasClass(y) && q[C].removeClass(y)
        }
    }, o = function () {
...
Muse.Utils.saveHyperlinkInfo = function (a, b, c, d, g) {
    ...
    if (f && -1 != f.indexOf("#") && !(i && i != "_self") && !(0 <= j.indexOf("/")) && (k.charAt(k.length - 1) == "/" && (k += "index.html"), -1 != k.indexOf("/" + j, k.length - j.length - 1))) {
        ...
        if (null !== Muse.Utils.allStyleSheetRules(c,
            ...
            i = 0;
            for (k = g.length; i < k; i++)if (g[i].href == f) {
                h = i;
                break
            }
            if (-1 == h) {
                ...
                j = Number.MAX_VALUE;
                i = 0;
                for (k = g.length; i < k; i++)if (g[i].href != f && g[i].from == d) {
                    h = i;
                    break
                }
                if (-1 == h) {
            ...
            if (!b.data("mu-ie-matrix")) {
                ...
                if (!c || !(c.toLowerCase().indexOf("opacity") > 0 && c.indexOf("=100") < 0)) {
                    if (a.childNodes.length && !Muse.Browser.Features.checkCSSFeature("border-radius") && (c = Muse.Utils.firstChild(a, Muse.Utils.Match.byNodeName("img"))) && c.nodeName.toLowerCase() == "img") {
                        ...
                        if ((f == "0px" || f == "auto") && (j == "0px" || j == "auto"))b.addClass("museBGSize"), b.css("background-size", "cover");
...
Muse.Utils.fullPage = function (a) {
    ...
    if (0 == $(a).closest(".breakpoint").length)Muse.Assert.assert(0 == $(".breakpoint").length, "Page is outside a breakpoint node."), b.init($(a)); else {
        var c = function (c) {
        ...
        if (Muse.Utils._initWidgetQueue && !Muse.Utils._hasBPListener) {
            var f = function (a, b, c, d) {
                ...
                if (Muse.Utils._initWidgetQueue[a]) {
                    for (; Muse.Utils._initWidgetQueue[a].length;)if (b = Muse.Utils._initWidgetQueue[a].shift(), b = b.fn($(b.id, c)))b.$bp = c, b.breakpoint = d;
    ...
    var b = [], c = function (a, b) {
        ...
        if (c) {
            if ("ready" == c.event) {
                ...
                if (d && d.length)for (var l = 0; l < d.length; l++)d[l]();
                f.data("readyQueue", null)
            }
            for (l = 0; l < b.length;)f = b[l], f.source == a.source && f.method == c.method ? (f.callbackFn(c.value), b.splice(l, 1)) : l++
        }
    };
...
(function (a) {
    ...
    d.prototype.updateScrollClass = function (a) {
        var a =
            this.spacerMinHeight < Math.floor(a * 100) / 100, b = !1;
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.1.2.344" != d.getAttribute("content") && Muse.assets.outOfDate.push("museutils.js");
                    break
                }
            }
        }
