...
(function (a, b, c, d, g) {
    c.Plugins.SlideShowCaptions = {
        defaultOptions: {captionClassName: "SSSlideCaption"}, initialize: function (b, c) {
            var d = this;
    ...
    c.Plugins.SlideShowLabel = {
        defaultOptions: {labelClassName: "SlideShowLabel"}, initialize: function (b, c) {
            var d = this;
            a.extend(c, a.extend({}, d.defaultOptions, c));
            b.bind("attach-behavior", function () {
                d._attachBehavior(b)
            ...
            var b = this, c = a._$sslpLabels ? a._$sslpLabels : a._findWidgetElements("." +
    ...
    c.Plugins.Lightbox = {
        ...
        _beforeTransformMarkup: function (a) {
            ...
            if (b.filter(":hidden").length == 0)a._sslbpSlideOffset = b.offset(); else {
        ...
        _initializeMarkup: function (b) {
            var d = b.options, g = d.elastic !== "off", i = b._findWidgetElements("." + d.viewClassName), k = b.slides.$element, l = i, m = b._sslbpSlideOffset, o = k.outerWidth(), r = k.outerHeight(), p = b._findWidgetElements(d.lightboxPartsSelector);
            if (0 == i.length) {
                ...
                l.css({width: o, height: r});
                d.transitionStyle === "fading" && k.css({position: "absolute", left: 0, top: 0});
                var y;
                ...
                l = a("<div/>").addClass("LightboxContent").css({position: "absolute"}).append(g ? t : l);
                g || l.append(c.Utils.includeMEditableTags(p));
                l.museOverlay({
                    autoOpen: !1, $slides: k, $overlaySlice: n,
                    $overlayWedge: q, slideshow: b, onNext: function () {
                        b.next()
                    }, onPrevious: function () {
                        b.previous()
                    }, onClose: function () {
                    ...
                    }, $elasticContent: t, resizeSlidesFn: y
                });
    ...
    c.Plugins.ContentSlideShow = {
        ...
        initialize: function (f, d) {
            var g = this, i = f.$element.hasClass("SlideShowWidget"), k = i ? g.slideShowOverrides : g.compositionOverrides;
            f._csspIsImageSlideShow = i;
            this._restartTimer = 0;
            a.extend(d, a.extend({}, g.defaultOptions, k, d));
            if (f.$element.hasClass("HeroFillFrame"))d.heroFitting = "fillFrameProportionally";
            ...
            if (d.elastic !==
                "off")f._csspPositionImage = g._positionImage;
            i && (b.Widget.ContentSlideShow.slideImageIncludePlugin.initialize(f, d), c.Plugins.SlideShowLabel.initialize(f, d), c.Plugins.SlideShowCaptions.initialize(f, d));
            ...
            if (d.contentLayout_runtime === "lightbox") {
                if (d.elastic !== "off")f._csspResizeFullScreenImages =
                    g._resizeFullScreenImages;
                if (0 < a(".LightboxContent").length)d.autoActivate_runtime = !1;
        ...
        _updateClipElement: function (b) {
            var d = b.options, g = b._findWidgetElements("." + d.viewClassName), i = b.$clipElement ? b.$clipElement : a("<div/>").addClass(d.clipClassName), k = b._findWidgetElements("." + d.slideClassName), l = k.outerWidth(), k = k.outerHeight();
            b.$clipElement = i;
            if (d.elastic === "fullScreen")i.addClass("fullscreen"); else {
                var b = {
                    position: "relative",
                    width: l + "px",
                    height: k + "px",
                ...
                if (m === "absolute")b.position = m, b.left = g.css("left"), b.top =
                    g.css("top"); else if (m === "fixed") {
            ...
            d.elastic !== "fullScreen" && g.css({width: l + "px", height: k + "px"});
            return i
        },
        _transformMarkup: function (a) {
            var b = a.options, c = a._findWidgetElements("." + b.viewClassName);
        ...
        _attachBehavior: function (b) {
            var g = this, h = b.options, i = b.tabs, k = b.slides.$element, l = h.slideLinkActiveClassName, m = h.contentLayout_runtime === "lightbox";
            if (h.elastic !== "off" && (g._resizeFullScreenImages(b, b.slides.$element, h.heroFitting), !m))a(d).on("orientationchange resize", function () {
                g._resizeFullScreenImages(b, b.slides.$element,
                    h.heroFitting)
            });
            ...
            if (i) {
                ...
                h.deactivationEvent === "mouseout_trigger" ? o.bind("mouseleave", function () {
                    ...
                    var c = a(this), d = o.index(c), g = k.eq(d);
                    c.data("enter", !1);
                    c.data("setTimeout") || (c.data("setTimeout",
                    ...
                    var c = a(this), d = k.index(c), g = o.eq(d);
                    c.data("enter", !1);
            ...
            i && l && (h.hideAllContentsFirst || i.$element.each(function (c) {
                c == b.slides.activeIndex ?
                    a(this).addClass(l) : a(this).removeClass(l)
            ...
            b._csspIsImageSlideShow || (b.slides.bind("wp-panel-hide", function (b, d) {
                ...
                this != b.slides.activeElement || h.hideAllContentsFirst ?
                    c.Utils.detachIframesAndObjectsToPauseMedia(a(this)) : c.Utils.attachIframesAndObjectsToResumeMedia(a(this))
            }));
        ...
        _hitTest: function (a, b) {
            ...
            var c = b.offset(), c = {x: c.left, y: c.top, width: b.outerWidth(), height: b.outerHeight()};
            return a.pageX >= c.x && a.pageX <= c.x + c.width &&
                a.pageY >= c.y && a.pageY <= c.y + c.height
        },
        _layoutThumbs: function (b) {
            var d = b.options, g = c.Utils.getStyleValue;
            b._findWidgetElements("." + d.slideLinksClassName).each(function () {
                ...
                topPos = paddingT;
                numInRow = 1;
                gStyle.height = (tHeight + borderT + borderB) *
                    numRow + gapV * (numRow - 1) + "px";
                b.each(function () {
        ...
        _resizeFullScreenImages: function (b, c, d) {
            c.each(function () {
                a(this).find("img").each(function () {
                    this.complete && !a(this).hasClass(b.options.imageIncludeClassName) && b._csspPositionImage(this,
                        d, b.options.elastic)
                })
            })
        },
        ...
        _positionImage: function (b, j, h, i, k) {
            var l = a(d), m = b.runtimeStyle ? b.runtimeStyle : b.style, o = h === "fullWidth" || h === "fullScreen", r = h === "fullHeight" || h === "fullScreen", p = j == "fitContentProportionally";
            $img = a(b);
            ...
            if (o == i && l == b)m.marginTop = "0px", m.marginLeft = "0px"; else {
                r = i;
                k = b;
                if (j == "fillFrameProportionally") {
                    if (h !== "off" || i > o && b > l)j = i / o, h = b / l, j < h ? (k = b / j, r = o) : (k = l, r = i / h)
                } else if (j == "fitContentProportionally" && (h !== "off" || i > o || b > l))j = i / o, h = b / l, j > h ? (k = b / j, r = i / j) : (k =
                    b / h, r = i / h);
    ...
    b.Widget.ContentSlideShow.prototype._getAjaxSrcForImage = function (b) {
        for (var c = a(d).data("ResolutionManager").getDataSrcAttrName(),
                 g = c.length, i, k = 0; k < g; k++)if ((i = b.data(c[k])) && i.length)return i;
        return b.data("src")
    }
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.1.2.344" != d.getAttribute("content") && Muse.assets.outOfDate.push("musewpslideshow.js");
                    break
                }
            }
        }
