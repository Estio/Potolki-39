...
(function (a) {
    a.fn.museMenu = function () {
        return this.each(function () {
            var b = this.id, c = a(this), d = c.closest(".breakpoint"), g = "absolute", f, j, h, i, k, l;
            if (!c.data("initialized")) {
                ...
                var m = function () {
                    ...
                    } else for (a = c.parent(); !a.is(document) && a.length > 0 && a.attr("id") != "page";) {
                ...
                t.each(function () {
                    ...
                    if (n && d.length > 0)b.data("offsetContainerRaw", a("<div style='position:" + g + "' class='MenuBar popup_element'></div>").hide().appendTo("body")), d.show(), o = d.position().top, d.hide();
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.1.2.344" != d.getAttribute("content") && Muse.assets.outOfDate.push("jquery.musemenu.js");
                    break
                }
            }
        }
