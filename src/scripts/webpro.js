...
(function (a, b) {
    ...
    var d = {
        version: 0.1, inherit: function (a, c) {
            ...
            f > 0 && (c = f > 1 || !a.isArray(arguments[0]) ? a.makeArray(arguments) : arguments[0]);
            return c
        }, hasPointerCapture: function () {
            return !!b.hasPointerCapture
        }, setPointerCapture: function (a, c) {
            if (c.pointerId && !b.hasPointerCapture)if (a.setPointerCapture)a.setPointerCapture(c.pointerId), b.hasPointerCapture = !0; else if (a.msSetPointerCapture)a.msSetPointerCapture(c.pointerId), b.hasPointerCapture = !0
            ...
            for (var d = " " + d + " ", i = [], c = a(c).find(b), b = c.length, h = a(h)[0], k = 0; k < b; k++)for (var l = c[k], m = l; m;) {
    ...
    a.extend(b.ImageLoader.prototype, {
        ...
        add: function (d, g) {
            ...
            if (!(this._currentEntry && this._currentEntry.src == a)) {
                var b;
                for (b = 0; b < this._queue.length; ++b)if (this._queue[b].src == a)break;
...
(function (a, b) {
    b.widget("Widget.RadioGroup", b.Widget, {
        ...
        _addButtonBehavior: function (a) {
            var d = this, g = new b.Widget.Button(a, {
        ...
        _handlePrev: function () {
            if (!this.options.disabled) {
                if (this.activeIndex > this._getElementIndex(this.firstButton.$element[0]))this.activeIndex--; else if (this.activeIndex === this._getElementIndex(this.firstButton.$element[0]) || this.activeIndex === -1)this.activeIndex = this._getElementIndex(this.lastButton.$element[0]);
        ...
        _handleNext: function () {
            if (!this.options.disabled) {
                if (this.activeIndex <
                    this.numButtons - 1)this.activeIndex++; else if (this.activeIndex === this.numButtons - 1)this.activeIndex = this._getElementIndex(this.firstButton.$element[0]);
                this._getElementByIndex(this.activeIndex).focus();
                this.checkButton(this.activeIndex)
            }
        },
...
(function (a, b) {
    b.widget("Widget.TabGroup", b.Widget.RadioGroup, {
        defaultOptions: {
            ...
            }), this.isPopupButtonWidget = !0; else if (this.numButtons > 1)this.parentElement = this.buttons[0].$element.parents(this.options.parentSelectors.join()), this.parentElement.attr("role",
...
(function (a, b) {
    b.widget("Widget.PanelGroup", b.Widget, {
        ...
        addTabGroup: function (c) {
            if (c)for (var c = b.ensureArray(c), d = c.length, g = 0; g < d; g++) {
                var f = c[g];
...
(function (a, b) {
    b.Widget.Disclosure.DisplayPropertyTransitionPlugin = {
        defaultOptions: {}, initialize: function (c, b) {
            var g = this;
            ...
            a.bind("wp-panel-show", function (a, c) {
                c.panel.style.display = "block"
            });
            a.bind("wp-panel-hide", function (a, c) {
...
(function (a, b, c, d, g) {
    b.Widget.ContentSlideShow.fadingTransitionPlugin = {
        defaultOptions: {transitionDuration: 500}, initialize: function (b, c) {
            var d = this;
            ...
            for (var m = 0; m < i.length; m++)if (m !== k)i[m].style.display = "none";
            if (f.options.elastic === "fullWidth") {
                ...
                if (f.options.contentLayout_runtime === "lightbox")f._fstpPositionSlides = p; else o.on("orientationchange resize", function () {
                    p()
                })
            }
                ...
                i.each(function () {
                    ...
                    c.swipe({
                        ...
                        swipeStatus: function (a, d, k, o) {
                            if (d == "start")f.stop(); else if (d == "move" && (g && (k == "left" ||
                                k == "right") || !g && (k == "up" || k == "down")))!b.hasPointerCapture() && Math.abs(o) > 1 && b.setPointerCapture(c[0], a), j._scrollTo(f, -1, o * (!h && (k == "left" || k == "up") || h && (k == "right" || k == "down") ? 1 : -1), 0); else if (d == "cancel")j._scrollTo(f, f.slides.activeIndex, 0, t), b.releasePointerCapture(c[0], a), f.trigger("wp-swiped"); else if (d == "end") {
                                d = f.slides.activeIndex;
                                o = -1;
                                if (g && (k == "right" && !h || k == "left" && h) || !g && (k == "down" && !h || k == "up" && h))o = d - 1 < 0 ? i.length - 1 : d - 1; else if (g && (k == "left" && !h || k == "right" && h) || !g && (k == "up" && !h ||
            ...
            if (!b._ftpSwipeNoInterrupt) {
                ...
                } else d = Math.abs(d), m = o.width(), d > m && (d = m), d = r.data("opacity") * (d / m), m = o.data("opacity") * (1 - d), o.stop(!1, !0).animate({opacity: m}, g), r.stop(!1, !0).show().animate({opacity: d},
                    g)
            }
        }
    };
    b.Widget.ContentSlideShow.filmstripTransitionPlugin = {
        defaultOptions: {transitionDuration: 500, transitionStyle: "horizontal"}, initialize: function (b, c) {
            var d = this;
            a.extend(c, a.extend({}, d.defaultOptions, c));
            b.bind("attach-behavior", function () {
                d.attachBehavior(b)
            ...
            var j = this, h = a(c), i = a(d.body), k = f.options, l = function () {
                ...
                }, m = k.transitionStyle === "horizontal", o = f.slides, r = o.$element, p = f.$clip ? f.$clip : f._findWidgetElements("." + k.clipClassName), n = f.$view ? f.$view : f._findWidgetElements("." + k.viewClassName), t = l(), q = p.height(),
                y = {left: 1, right: 1}, C = {up: 1, down: 1}, w = {top: "0", left: "0"};
            f.$clip = p;
            f.$view = n;
            var v = p.css("position");
            ...
            f.options.contentLayout_runtime === "stack" && f.bind("wp-slideshow-close", function () {
                p.css({opacity: 0.99}).stop(!0).animate({opacity: 0}, {
                    queue: !1,
            ...
            if (k.elastic === "fullWidth")for (var z = 0; z < r.length; z++) {
                var s = a(r[z]);
                s.width("100%");
                s.addClass("borderbox")
            }
            if (k.elastic !== "off")if (k.contentLayout_runtime === "lightbox")f._fstpPositionSlides = D; else h.on("orientationchange resize", function () {
                D()
            ...
            Muse.Browser.Features.Touch && f.options.enableSwipe === !0 && (a(this), m ? n.addClass("horizontalSlideShow") : n.addClass("verticalSlideShow"), n.swipe({
                ...
                swipeStatus: function (a, c, d, g) {
                    ...
                    switch (c) {
                        ...
                        case "move":
                            if (m &&
                                d in y || !m && d in C)!b.hasPointerCapture() && Math.abs(g) > 1 && b.setPointerCapture(n[0], a), j._scrollBy(f, g * h);
                            break;
                        case "cancel":
            ...
            l[g] = d - b + "px";
            c.css(l)
        }, _finalizeSwipe: function (a,
                                     b, c) {
            var d = a.slides, g = a._fstp$View, l = b / a._fstpOffsetSize, b = a._fstpStyleProp, m = {}, l = c === 1 ? Math.ceil(l) : Math.floor(l), l = Math.max(0, Math.min(l, d.$element.length - 1));
            ...
            if (b) {
                ...
                if (n && t !== -1) {
                    var q = b.slides.activeIndex, y = b.slides.$element.length - 1;
                    if (q !== t) {
                        var C = 0;
    ...
    b.Widget.ContentSlideShow.alignPartsToPagePlugin = {
        defaultOptions: {alignPartToPageClassName: "wp-slideshow-align-part-to-page"}, initialize: function (b, c) {
            var d = this;
            a.extend(c, a.extend({},
                d.defaultOptions, c));
            b.bind("attach-behavior", function () {
            ...
            if (!("fullWidth" !== b.options.elastic || !b.$element.hasClass("align_parts_to_page") || "fixed" !== b.$element.css("position") || b.options.contentLayout_runtime === "lightbox")) {
                ...
                b.$element.children().each(function () {
                    var b = a(this);
                    0 < a("." +
                        i.viewClassName, b).length || b.addClass(i.alignPartToPageClassName)
                });
                k();
    ...
    b.Widget.ContentSlideShow.slideImageIncludePlugin = {
        defaultOptions: {
            ...
            for (var b =
                this, c = a._cssilLoader, d = a._findWidgetElements("." + a.options.slideClassName), g = d.length, l = "." + a.options.imageIncludeClassName, m = a.options.slideLoadingClassName, o = function (c, d, g, h) {
                ...
                if (t) {
                    ...
                    if (q)n = {
                        ...
                        $ele: n,
                        $slide: p
                    }, t.style.visibility = "hidden", c.add(q, {callback: o, data: n}), p.addClass(m)
                }
            }
        ...
        _handleImageLoad: function (a, b, c, d, g) {
            var l = g.$ele, m = l[0];
            m.src = b;
            a.options.elastic !== "off" ? (l.data("imageWidth", c), l.data("imageHeight", d), a._csspPositionImage(m, a.options.heroFitting, a.options.elastic, c, d)) : (m.width = g.width || c, m.height = g.height || d);
            m.style.visibility = "";
    ...
    {
        defaultOptions: {randomDefaultIndex: !0}, initialize: function (b, c) {
        var d = this;
        a.extend(c, a.extend({}, d.defaultOptions, c));
        b._shuffleArray = [];
        b._shuffleNextDict = {};
        ...
        var b = a._shuffleArray, c = {}, d = a.slides ? a.slides.$element.length : a._findWidgetElements("." + a.options.slideClassName).length;
        ...
        if (a.isPlaying()) {
            ...
            a._isLoaded(b) && a._isLoaded(c) && (a._goTo(c), ++a._shufflePlayCount >=
            a.slides.$element.length && (this._reshuffle(a), (!a.options.loop || a.options.playOnce) && a.stop()))
        } else a._realNext()
    }
    }
})(jQuery, WebPro, window, document);
    ...
    b.widget("Widget.Form", b.Widget, {
        ...
        _updateReCaptchaChallenge: function () {
            ...
            if (0 != b.length) {
                ...
                for (var b = a("#recaptcha_image", this.$element), c = ["#ReCaptchaV2", "#ReCaptchaAnswer", "#ReCaptchaChallenge"], f = 0; f < c.length; f++)if (0 == a(c[f], b).length) {
                    var j = a(c[f]);
                    b.after(j)
                }
            }
                ...
                type: "post", data: this.$element.serialize(), beforeSend: function () {
                    ...
                    if (l && l.success) {
                        ...
                        b.$element.find("." + b.options.notEmptyClass).each(function () {
                            ...
                            b._getFieldsWithError(l))for (l = 0; l < h.length; l++)b._switchState("invalid", h[l]); else b.$element.addClass(j);
        ...
        _switchState: function (a, b) {
            ...
            if ("checkbox" == c || "radio" == c)if ((l = this._getGroupField(b)) && l.hasClass(i)) {
                b.addClass(i);
                return
            }
            b.addClass(j);
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.1.2.344" != d.getAttribute("content") && Muse.assets.outOfDate.push("webpro.js");
                    break
                }
            }
        }
